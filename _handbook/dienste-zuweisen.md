...
wird darauf gelöscht. Falls Sie eine Bewerbung löschen wollen, so klicken Sie einfach auf die Bewerbung. 
Sie werden darauf hin gefragt, ob Sie die Bewerbung entfernen möchten und können sie so entfernen.

Falls Sie die Dienstzeit ändern wollen, so können Sie über das Stift-Icon rechts oben die Eigenschaften von 
dem Dienst bearbeiten.

Um einen Dienst für die Mitarbeiter attraktiver zu gestalten können Sie auch eine Sondervergütung definieren.
Dabei kann sowohl ein höherer Stundensatz als auch ein Sonderbonus für die gesamte Schicht definiert werden.
Um dies zu dokumentieren können Sie auch eine interne Notiz hinterlegen, die der Mitarbeiter nicht sehen kann.
